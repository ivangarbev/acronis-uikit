...
// dedicated `--ui-button-icon-*` tokens. Like Button, disabled uses the design's
// explicit disabled tokens (not opacity) and the focus ring uses `--ui-focus-*`.
const buttonIconClasses =
  ...
  'hover:bg-[var(--ui-button-icon-background-hover)] hover:text-[var(--ui-button-icon-icon-hover)] ' +
  'active:bg-[var(--ui-button-icon-background-active)] active:text-[var(--ui-button-icon-icon-active)] ' +
